...
namespace ODataBookStore.Utilities
{
    public static class Ultils
    {
        ...
        public static byte[] GetHash(string password, string config)
        {
            //convert conbine password and config of appsetting
            byte[] byteCode = Encoding.Unicode.GetBytes(string.Concat(password, config));
